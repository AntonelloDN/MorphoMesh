...
{
    public class ReduceByVertex : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public ReduceByVertex()
          : base("ReduceMeshByVertex", "ReduceMeshByVertex",
              "Use this component to simplify meshes by reducing the number of vertices.",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("num", "num", "Max Number of vertices of the output mesh.", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (runIt)
            {
                ...
                var newMesh = MeshMorphoLib.MeshClassFnc.ReduceByVertexCount(g3mesh, num);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return MorphoMeshEdit.Properties.Resources.ReduceByVertex;
            }
        }
        ...
        {
            get { return new Guid("0a6645ba-a151-4b9a-9266-7a1f7f02e973"); }
        }
    }
}