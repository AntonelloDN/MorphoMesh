...
namespace MorphoMeshEdit
{
    public class ImplicitDifference : GH_Component
    {
        ...
        public ImplicitDifference()
          : base("ImplicitDifference", "ImplicitDifference",
              "Use this component to run Boolean Difference between two meshes.",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (runIt)
            {
                ...
                var implicitDiffDone = MeshMorphoLib.MeshClassFnc.ImplicitDifference(implicitA, implicitB);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return MorphoMeshEdit.Properties.Resources.ImplicitDifference;
            }
        }
        ...
        {
            get { return new Guid("8ffa9b46-5b7a-486c-b894-df35456e3689"); }
        }
    }
}