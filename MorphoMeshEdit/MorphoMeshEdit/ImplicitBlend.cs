...
{
    public class ImplicitBlend : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public ImplicitBlend()
          : base("ImplicitBlend", "ImplicitBlend",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("blend", "blend", "Connect a double  to produce a continuous blend.", GH_ParamAccess.item, 1.0);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return MorphoMeshEdit.Properties.Resources.ImplicitBlend;
            }
        }
        ...
        {
            get { return new Guid("4db1f6b8-5fea-422b-a125-d45bd1091837"); }
        }
    }
}