...
{
    public class ImplicitSmoothDifference : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public ImplicitSmoothDifference()
          : base("ImplicitSmoothDifference", "ImplicitSmoothDifference",
              "Use this component to run smooth Boolean Difference between two meshes.",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (runIt)
            {
                ...
                var implicitDiffDone = MeshMorphoLib.MeshClassFnc.ImplicitSmoothDifference(implicitA, implicitB);
                DMesh3 newMesh = MeshMorphoLib.MeshClassFnc.GenerateMeshF(implicitDiffDone, num);
                if (showIt)
                {
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return MorphoMeshEdit.Properties.Resources.ImplicitSmoothDifference;
            }
        }
        ...
        {
            get { return new Guid("9b56577b-ea48-4763-bffb-724e9f5a4cdb"); }
        }
    }
}