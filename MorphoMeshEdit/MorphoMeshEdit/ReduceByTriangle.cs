...
{
    public class ReduceByTriangle : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public ReduceByTriangle()
          : base("ReduceMeshByTriangle", "ReduceMeshByTriangle",
              "Use this component to simplify meshes by reducing the number of triangles.",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("num", "num", "Max Number of triangles of the output mesh.", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (runIt)
            {
                ...
                var newMesh = MeshMorphoLib.MeshClassFnc.ReduceByTriangleCount(g3mesh, num);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return MorphoMeshEdit.Properties.Resources.ReduceByTringle;
            }
        }
        ...
        {
            get { return new Guid("84e560b0-8691-415d-9393-6e731c9e6b10"); }
        }
    }
}