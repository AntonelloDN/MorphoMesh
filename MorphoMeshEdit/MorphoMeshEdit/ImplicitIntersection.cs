...
namespace MorphoMeshEdit
{
    public class ImplicitIntersection : GH_Component
    {
        ...
        public ImplicitIntersection()
          : base("ImplicitIntersection", "ImplicitIntersection",
              "Use this component to run Boolean Intersection between two meshes.",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (runIt)
            {
                ...
                var implicitIntersectionDone = MeshMorphoLib.MeshClassFnc.ImplicitIntersection(implicitA, implicitB);
                DMesh3 newMesh = MeshMorphoLib.MeshClassFnc.GenerateMeshF(implicitIntersectionDone, num);
                if (showIt)
                {
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return MorphoMeshEdit.Properties.Resources.ImplicitIntersection;
            }
        }
        ...
        {
            get { return new Guid("43355716-4c55-48c3-b201-b46d0fe88d13"); }
        }
    }
}