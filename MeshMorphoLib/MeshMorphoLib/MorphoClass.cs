...
namespace MeshMorphoLib
{
    public class MeshClassFnc
    {
        ...
        public static DMesh3 ReduceByTriangleCount(DMesh3 mesh, int count)
        {
        ...
        public static DMesh3 ReduceByVertexCount(DMesh3 mesh, int count)
        {
            Reducer outputMesh = new Reducer(mesh);
            outputMesh.ReduceToVertexCount(count);

            return new g3.DMesh3(outputMesh.Mesh, true);
        }


        public static DMesh3 ReduceByEdgeLength(DMesh3 mesh, double minEdgeLen)
        {
            Reducer outputMesh = new Reducer(mesh);
            outputMesh.ReduceToEdgeLength(minEdgeLen);
